            ...
            <div className='md:w-11/12 mx-auto '>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mt-10 gap-1.5 space-y-5'>
                    ...
                    animate={{ rotate: 360 }}
                     ...
                     className='text-center space-y-2 mx-2 py-10 rounded-xl bg-white shadow-md'>
                    ...
                    animate={{ rotate: 360 }}
                        transition={{ duration: 1 }}
                        whileHover={{ scale: 1.1 }}
                        whileTap={{ scale: 0.8 }} className='text-center space-y-2 mx-2 py-10 rounded-xl bg-white shadow-md'>
                    ...
                    animate={{ rotate: 360 }}
                        ...
                        <p className='text-gray-500'>Select the Car based on your Budget and apply for booking</p>
                    </motion.div>
                    {/* four  */}
                    <motion.div
                    animate={{ rotate: 360 }}
                        transition={{ duration: 1 }}
                        whileHover={{ scale: 1.1 }}
                        whileTap={{ scale: 0.8 }} className='text-center space-y-2 mx-2 py-10 rounded-xl mb-5  bg-white shadow-md'>
                        <FaCheck className='justify-self-center mb-8 text-blue-700' size={35} />
                        <h3 className='text-2xl font-semibold'>Get Booked</h3>
                        <p className='text-gray-500'>Once your booking is confirmed, start <br></br> enjoying your ride </p>
                    </motion.div>
