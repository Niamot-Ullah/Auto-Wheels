...
const UpdateCar = () => {
    ...
    const {_id,model,price,availability,features,description,image,location} = data.data
    ...
    const handleUpdate = (e) => {
            ...
            // console.log(data);
            fetch(`${import.meta.env.VITE_API_URL}/update-car/${_id}`, {
                method: 'PUT',
                headers: {
                ...
                <div className="hero-content flex-col lg:flex-row-reverse ">
                    ...
                    <div className="card bg-base-100 w-full max-w-sm shrink-0 ">
                        <div className="card-body">
                            ...
                            <h1 className="text-4xl font-bold pb-1 text-blue-800">Update  Your Car!</h1>

                            <form  onSubmit={handleUpdate}>
                                {/* model  */}
                                <label  className="label text-black font-bold text-lg pb-1 mt-5">Car Model</label>
                                <input defaultValue={model} name='model' type="text" className="input md:w-[500px] mb-6" placeholder="Enter Car Model" />
                                {/* Daily Rental Price  */}
                                <label className="label text-black font-bold text-lg pb-1 ">Daily Rental Price(BDT)</label>
                                <input defaultValue={price} name='price' type="text" className="input md:w-[500px] mb-5" placeholder="Enter Daily Rental Price" />
                                {/* Registration Number */}
                                ...
                                <select  name='availability' defaultValue="Enter Availability" className="select md:w-[500px] mb-5 text-gray-600">
                                    <option defaultValue={availability} disabled={true}>Enter Availability</option>
                                ...
                                <input defaultValue={features} name='features' type="text" className="input md:w-[500px] mb-6" placeholder="Enter Features separated by commas" />
                                {/* Description */}
                                <label className="label text-black font-bold text-lg pb-1 ">Description</label>
                                <textarea defaultValue={description} name='description' className="textarea h-30 md:w-[500px] mb-5" placeholder="Write detail about the Car..."></textarea>

                                {/* Image URL */}
                                <label className="label text-black font-bold text-lg pb-1 ">Image URL</label>
                                <input defaultValue={image} name='image' type="text" className="input md:w-[500px] mb-5" placeholder="Enter Image URL" />
                                {/* Location */}
                                <label className="label text-black font-bold text-lg pb-1 ">Location</label>
                                <input defaultValue={location} name='location' type="text" className="input md:w-[500px] mb-5" placeholder="Enter Location" />
                                {/* Your Name */}
